--To show the error message, before executing the procedure, first this error_logs table is created. 
--The procedure should raise an insufficient_funds exception.
--An error message should be inserted into this table.
...
--Now query the error_logs table to see if an error message has been inserted.
--Look for the message "Insufficient funds for transfer".